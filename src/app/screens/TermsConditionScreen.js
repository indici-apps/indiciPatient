...
import { StyleSheet, Text, View, TouchableOpacity, TouchableHighlight, Image, Platform, AsyncStorage } from 'react-native';
...
//     try {
//         const userToken = await AsyncStorage.getItem('secureToken');
//         return userToken;
//         //alert(user);
//     }
//     catch (error) {
