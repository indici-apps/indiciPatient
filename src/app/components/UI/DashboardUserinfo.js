    ...
    return (
        <View style={styles.loginMenu}>
            <View style={styles.dashboard_content_text}>
                <Text style={styles.dashboard_content_text_mariaSnow}>{props.fullname}</Text>
                <Text style={styles.dashboard_content_text_sanFranciscoCa}>{props.familyName}</Text>
                <Text style={styles.dashboard_content_text_x20Years}>{props.nhi}</Text>
            </View>
